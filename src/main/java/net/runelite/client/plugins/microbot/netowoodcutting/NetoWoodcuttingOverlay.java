...
public class NetoWoodcuttingOverlay extends OverlayPanel {
    ...
    private final NetoWoodcuttingConfig config;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Neto Woodcutting v" + NetoWoodcuttingPlugin.version)
                    .color(TITLE_COLOR)
                    .build());
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    .left("Status:")
                    .right(this.plugin.netoWoodcuttingScript.woodcuttingScriptState.toString())
            ...
            if (config.distanceToStray() < 21) {
                LocalPoint lp = LocalPoint.fromWorld(client, NetoWoodcuttingScript.getReturnPoint(config));
                if (lp != null) {
