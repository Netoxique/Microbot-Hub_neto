package net.runelite.client.plugins.microbot.netosailingsalv.features.trials;
...
import net.runelite.client.plugins.microbot.netosailingsalv.features.trials.data.*;
import net.runelite.client.plugins.microbot.netosailingsalv.features.trials.debug.BoatPathHelper;
...
public class TrialsScript {
    ...
    public void onConfigChanged(ConfigChanged event) {
        ...
        if (event.getGroup().equals(NetoSailingSalvConfig.configGroup)) {
