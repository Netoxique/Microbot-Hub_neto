...
import net.runelite.client.plugins.microbot.netoagility.enums.AgilityEquipmentOption;
import net.runelite.client.plugins.microbot.netoagility.enums.AgilityFoodOption;
import net.runelite.client.plugins.microbot.netoagility.enums.AgilityPotionOption;
...
class NetoAgilitySupplyManager
{
	...
	private final NetoAgilityPlugin plugin;
	private final NetoAgilityConfig config;
	...
	NetoAgilitySupplyManager(NetoAgilityPlugin plugin, NetoAgilityConfig config, BooleanSupplier shuttingDown, Runnable shutdown)
	{
		this.plugin = plugin;
		this.config = config;
