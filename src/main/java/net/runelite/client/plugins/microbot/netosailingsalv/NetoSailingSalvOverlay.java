...
public class NetoSailingSalvOverlay extends OverlayPanel {
    ...
    @Inject
    NetoSailingSalvOverlay(NetoSailingSalvPlugin plugin, Client client, NetoSailingSalvConfig config, SalvagingScript netoSalvagingScript) {
        super(plugin);
        this.client = client;
        this.config = config;
    ...
    private void addTitle() {
        panelComponent.getChildren().add(TitleComponent.builder()
                .text("Sailing v" + NetoSailingSalvPlugin.version)
    ...
    private void addShipwreckInfo() {
        ...
        try {
            var activeWrecks = netoSalvagingScript.getActiveWrecks();
            var inactiveWrecks = netoSalvagingScript.getInactiveWrecks();
