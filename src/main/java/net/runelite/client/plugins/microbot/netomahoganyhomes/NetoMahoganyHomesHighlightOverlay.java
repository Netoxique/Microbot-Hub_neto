...
class NetoMahoganyHomesHighlightOverlay extends Overlay
{
    ...
    private final NetoMahoganyHomesConfig config;

    @Inject
    NetoMahoganyHomesHighlightOverlay(NetoMahoganyHomesPlugin plugin, NetoMahoganyHomesConfig config)
    {
        super(plugin);
