...
@ConfigGroup("NetoSalvaging")
@ConfigInformation("• This plugin will deposit items, withdraw salvage items, and sort them at the Salvaging station.")
public interface NetoSalvagingConfig extends Config, BreakSettings, WorldHopSettings, RuntimeSettings {
    @ConfigSection(
            name = "Settings",
